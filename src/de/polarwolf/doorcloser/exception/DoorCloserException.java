package de.polarwolf.doorcloser.exception;

public class DoorCloserException extends Exception {
	...
	public DoorCloserException(String contextName, String errorName, String errorDetailText) {
	...
	public DoorCloserException(String contextName, String errorName, String errorDetailText, Throwable cause) {
